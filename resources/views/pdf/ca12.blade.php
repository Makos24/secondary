...
<form method="post" action="{{url('/results/postca12')}}" id="bulkform">
...
<table class="table table-responsive">
    ...
    <tr>
        ...
        <td width="120px"><input type="number" name="ca1[]" class="form-control" required></td>
        <td width="120px"><input type="number" name="ca2[]" class="form-control" required ></td>
        </tr>
    @endforeach
    </tbody>
</table>
