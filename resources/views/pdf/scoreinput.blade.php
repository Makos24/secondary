...
<form method="post" action="{{url('/inputresults')}}" id="bulkform">
...
<table class="table table-responsive">
    ...
    <tr>
        ...
        <td width="80px"><input type="text" name="ca1[]" class="form-control" required></td>
        <td width="80px"><input type="text" name="ca2[]" class="form-control" required ></td>
        <td width="80px"><input type="text" name="exam[]" class="form-control" required></td>
    </tr>
    @endforeach
    </tbody>
</table>
