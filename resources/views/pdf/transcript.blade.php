...
<div class="body" id="{{$levels = $results->groupBy('class')}}">
@include('pdf.header')

    <table class="noborder">
    <tr>
        <td width="110px"><strong>Student Name:</strong></td>
        <td class="underline">{{$student->name}}</td>
        <td width="140px"><strong>Admission Number:</strong></td>
