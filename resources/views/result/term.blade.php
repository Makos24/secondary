    ...
    <div class="page">
        ...
        <table cellspacing="0" class="table">
            <tr>
                ...
                <th><div class="rotate">1ST CA</div><div>15%</div></th>
                <th><div class="rotate">2ND CA</div><div>15%</div></th>
                <th><div class="rotate">EXAM</div><div>70%</div></th>
                <th><div class="rotate">TOTAL</div><div>100%</div></th>
                <th><div class="rotate">COMMENT</div></th>

            </tr>
            @foreach($all as $k => $a)
                <tr  @if(($a['ca1']+$a['ca2']+$a['exam']) < 40) class="fail" @endif>
...
@elseif(session()->get('section') == "secondary")
    ...
    <div class="box">
        @if($term == 3)
            ...
            <table class="noborder">
                <tr>
                    <td width="78px"><strong>Name of Student:</strong></td><td colspan="2" class="underline">
                        {{$student->name}}</td>
                    <td width="150px"></td>
                    <td width="40px"><strong>Term</strong></td>
                    <td width="80px" class="underline" >{{Auth::user()->ordinal($term)}}</td>
                </tr>
            </table>
            <table class="noborder">
                <tr id="{{$attendance = $student->attendances->where('term',$term)->where('class',$level)->where('session',$session)->first()}}">
                    <td width="105px"><strong>Maximum Attendance:</strong></td>
                    ...
                    <td width="100px"></td>
                    <td width="70px"><strong>Times Present:</strong></td>
                    <td class="underline" >
                        @if(isset($attendance->present))
                            {{$attendance->present}}
                        @endif
                    </td>
                    <td width="40px"><strong>Class:</strong></td>
                    <td class="underline" >{{$student->student_class}}</td>
                </tr>
            </table>
            <table class="noborder">
                <tr>
                    <td width="85px"><strong>Next Term Begins:</strong></td>
                    <td class="underline">
                    ...
                    <td width="300px"></td>
                    <td width="40px"><strong>Date</strong></td>
                    <td class="underline" >
                        @if($pos = $student->positions->where('level', $level)->where('term', $term)->first()->term_settings)
                ...
                <div class="tdiv">
                    <table cellspacing="0" class="table" id="{{$tsubjects = $results->groupBy('subject_id')}}">
                        <tr>
                            ...
                            <th><div class="rotate">1ST TERM<br> SCORE</div></th>
                            <th><div class="rotate">2ND TERM <br> SCORE</div></th>
                            <th><div class="rotate">3RD TERM <br> SCORE</div></th>
                            <th><div class="rotate">CUM <br> AVERAGE</div></th>
                            <th><div class="rotate">GRADE</div></th>
                            <th><div class="rotate">TEACHERS <br> REMARK</div></th>
                            <th width="30px"><div class="rotate">SIGNATURE</div></th>

                        </tr>

                        @foreach($tsubjects as $k => $subjects)
                            <tr id="{{$subject = $subjects->groupBy('term')}}{{$average=$subjects->sum('total')/count($subjects)}}"  @if($average < 40) class="fail" @endif>
            ...
            <div class="base">
                ...
                <table class="noborder">
                    <tr>
                        ...
                        <td width="130px"><strong>2nd TERM POSITION:</strong></td>
                        ...
                        <td width="120px"><strong>ANNUAL POSITION:</strong></td>
                        <td class="underline" width="70px" >{{$p3 ? $p3->overall_pos : ''}}</td>
                    </tr>
                </table>

                <table class="noborder" >
                    <tr>
                        <td width="135px"><strong>Class Teacher's Comment :</strong></td>
                        <td class="underline">
                ...
                <table class="noborder">
                    <tr>
                        <td width="130px"><strong>Class Teacher's Name :</strong></td>
                ...
                <table class="noborder" >
                    <tr>
                        <td width="100px"><strong>Principal's Comment :</strong></td>
                        <td class="underline">
                ...
                <div class="tdiv">
                    <table cellspacing="0" class="table">
                        <tr>
                            ...
                            <th><div class="rotate">1ST CA TEST</div></th>
                            <th><div class="rotate">2ND CA TEST</div></th>
                            <th><div class="rotate">EXAM</div></th>
                            <th><div class="rotate">TOTAL</div></th>
                            <th class="col"><div class="rotate">CLASS<br> HIGHEST</div></th>
                            <th><div class="rotate">CLASS<br> AVERAGE</div></th>
                            <th><div class="rotate">CLASS<br> LOWEST</div></th>
                            <th><div class="rotate">POSITION <br> IN CLASS</div></th>
                            <th><div class="rotate">GRADE</div></th>
                            <th><div class="rotate">TEACHERS <br> REMARK</div></th>
            ...
            <div class="base">
                <table class="noborder">
                    <tr>
                        ...
                        <td width="79px"><strong>Position in Class:</strong></td>
                ...
                <table class="noborder">
                    <tr>
                        <td width="125px"><strong>Class Teacher's Comment :</strong></td>
                        <td class="underline">
                            @if($pos = $student->positions->where('level', $level)->where('term', $term)->first())
                                {{$pos->comment}}
                            @endif
                ...
                <table class="noborder">
                    <tr>
                        <td width="110px"><strong>Class Teacher's Name :</strong></td>
                        <td class="underline" width="300px">
                ...
                <table class="noborder">
                    <tr>
                        <td width="100px"><strong>Principal's Signature</strong></td>
                        <td class="underline"></td>
                        <td width="150px"></td>
                        <td width="40"><strong>Date</strong></td>
                        <td class="underline"></td>
